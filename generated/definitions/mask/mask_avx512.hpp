...
namespace tvl {
   ...
   namespace details {
      template<  ImplementationDegreeOfFreedom Idof >
      struct insert_delim_zero_impl< simd< uin64_t, avx512 >, Idof > {
         using Vec = simd< uin64_t, avx512  >;
         static constexpr bool native_supported() {
            return true;
         }
   /*
    ...
    */
         ...
         TVL_FORCE_INLINE static typename Vec::mask_type apply(
            ...
            return _pdep64; //mask is integral already.
         }
      };
   } // end of namespace details for template specialization of insert_delim_zero_impl for avx512 using uin64_t.
