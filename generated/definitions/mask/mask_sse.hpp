...
namespace tvl {
   ...
   namespace details {
      template<  ImplementationDegreeOfFreedom Idof >
      struct insert_delim_zero_impl< simd< int64_t, sse >, Idof > {
         using Vec = simd< int64_t, sse  >;
         static constexpr bool native_supported() {
            return true;
         }
   ...
   } // end of namespace details for template specialization of insert_delim_zero_impl for sse using int64_t.
