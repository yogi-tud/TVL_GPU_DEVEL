...
namespace tvl {
   ...
   namespace details {
      template<  ImplementationDegreeOfFreedom Idof >
      struct insert_delim_zero_impl< simd< int64_t, avx2 >, Idof > {
         using Vec = simd< int64_t, avx2  >;
         static constexpr bool native_supported() {
            return true;
         }
   ...
   } // end of namespace details for template specialization of insert_delim_zero_impl for avx2 using int64_t.
